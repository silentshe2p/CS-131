class UnsafeMemory {
    public static void main(String args[]) {
			...
			try {
				...
				dowork(nThreads, nTransitions, s, args[0], nThreads);
    ...
    private static void usage(Exception e) {
			...
			System.err.println("Usage: model nthreads ntransitions" + " maxval n0 n1 ...\n");
			System.exit (1);
    }
    ...
    private static void dowork(int nThreads, int nTransitions, State s, String model, int threadNums) throws InterruptedException {
